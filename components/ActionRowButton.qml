...
Rectangle {
    ...
    radius: buttonRadius
    color: !enabled ? disabledBackgroundColor : (hovered ? hoverBackgroundColor : backgroundColor)
    border.width: 1
    border.color: !enabled ? disabledBorderColor : (hovered ? hoverBorderColor : borderColor)
